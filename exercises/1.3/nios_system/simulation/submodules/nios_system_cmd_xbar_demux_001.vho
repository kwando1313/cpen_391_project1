...
--synthesis_resources = 
 ...
 ARCHITECTURE RTL OF nios_system_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_nios_system_cmd_xbar_demux_001_wideor0_17_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_nios_system_cmd_xbar_demux_001_wideor0_17_dataout <= (((((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0)) OR wire_w_lg_w_sink_channel_range18w19w(0)) OR wire_w_lg_w_sink_channel_range21w22w(0));
	sink_ready <= s_wire_nios_system_cmd_xbar_demux_001_wideor0_17_dataout;
