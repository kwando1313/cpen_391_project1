...
--synthesis_resources = 
 ...
 ENTITY  nios_system_rsp_xbar_demux_006 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END nios_system_rsp_xbar_demux_006;

 ARCHITECTURE RTL OF nios_system_rsp_xbar_demux_006 IS
 ...
 END RTL; --nios_system_rsp_xbar_demux_006
